...
async function cleanupLearning(){
  ...
  try{
    var prompt='너는 트레이딩 멘토. 아래 학습 노트를 정리해서 **최종 버전**을 만들어줘.\n\n'+
      '정리 원칙:\n'+
      '- 같은 교훈이 여러 번 반복되면 가장 구체적인 1개로 병합\n'+
      '- 마크다운 헤더(##, #)만 있는 줄은 삭제\n'+
      '- "전략 유지", "정상", "양호" 같은 의미없는 조언은 삭제\n'+
      '- 구체적 실수, 손절 기준, 멘토 조언 등 중요한 건 반드시 유지\n'+
      '- 비슷한 내용은 하나로 합쳐서 더 강력하게 표현\n'+
      '- 최소 5개 이상 남길 것\n\n'+
